...
<div class="col-md-6 panel" style="background-color: white;">
...
<div class="col-md-10">
<a href="mailto:mmmpatelmukesh2001@gmail.com" style="color:#000000">mmmpatelmukesh2001@gmail.com</a><br /><br />
...
<a href="https://galgotiacollege.edu/welcome-to-gcet" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p>
          <div class="row">
          <div class="col-md-4">
              <h3 style="font-family:'typo' ">Roll Number</h3>
              <h4 style="font-family:'typo' ">2200970140123</h4>
              <h4 style="font-family:'typo' ">2200970140099</h4>
              <h4 style="font-family:'typo' ">2200970140129</h4>
            </div>
            <div class="col-md-5">
              <h3 style="font-family:'typo' ">Name</h3>
              <h4 style="font-family:'typo' ">Vibha Saroha</h4>
              <h4 style="font-family:'typo' ">Saquib Malik</h4>
              <h4 style="font-family:'typo' ">Yash Vardhan Singh</h4>
            </div></div>
              </p>
            </div>
